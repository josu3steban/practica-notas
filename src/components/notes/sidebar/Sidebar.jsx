  ...
  return (
      <aside
        ...
        ">
          ...
          <section className="flex items-center gap-5 hover:shadow-md border-2 border-transparent hover:border-my-color-five p-2 rounded-md transition-all duration-300 cursor-pointer m-2">
            <div className="w-1/5">
          ...
          <footer className="p-2 text-right">
            <button className="w-auto px-2 uppercase border rounded-md bg-my-color-four text-my-color-two font-medium">salir</button>
          </footer>
